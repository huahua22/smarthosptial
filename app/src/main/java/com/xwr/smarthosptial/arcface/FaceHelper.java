...
//    private Camera.Size previewSize;
     ...
     */
    public List<FacePreviewInfo> onPreviewFrame(byte[] nv21,int format) {
        if (faceListener != null) {
            if (ftEngine != null) {
                faceInfoList.clear();
                int code = ftEngine.detectFaces(nv21, previewSize.width, previewSize.height, format, faceInfoList);
